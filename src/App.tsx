...
export default function App() {
  ...
  const editPlan = async (edit: PlanEdit) => {
    ...
    try {
      ...
      if (data.selected !== selected || !['scene-settings', 'scene-seed-random', 'plan-defaults', 'shared-direction'].includes(edit.type)) select(data.selected as number);
