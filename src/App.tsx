...
export default function App() {
  ...
  return <div className="app-shell">
    <header className="app-header"><div className="brand"><div className="brand-mark"><Layers size={22}/></div><strong>SceneWeaver</strong><span className="alpha">COMPANION 0.2.2</span></div>
    ...
    <Timeline plan={plan} inputs={planNode?.inputs || {}} checkpoints={server.checkpoints} editorial={server.editorial} selected={selected} select={select} add={addScene} currentTime={currentTime} onSeek={seconds => player.current?.seekScene(seconds)}/>
