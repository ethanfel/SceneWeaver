  ...
  return <aside className="inspector panel">
    ...
    <div className="inspector-body">
      {p.tab === 'scene' && p.plan && planNode ? <>
        ...
        {isLink(planNode.inputs.plan_json_input) && <div className="notice">An upstream node supplies the runtime plan. These scenes are its fallback. Edit the connected source in Node settings.</div>}
        {shot ? <>
