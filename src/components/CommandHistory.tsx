...
const labels: Record<string, string> = { 'asset-library-mutate': 'Organize project library', 'prompt-history-mutate': 'Change prompt history', 'editorial-apply': 'Save sequence edit', deliver: 'Assemble saved selection', 'generate-range': 'Generate scenes', 'branch-command': 'Working branch', patch: 'Apply draft', queue: 'Queue workflow', 'workflow-save': 'Save workflow', 'take-final-cut': 'Choose final cut', 'checkpoint-activate': 'Restore checkpoint', 'asset-update': 'Edit asset', 'asset-upload': 'Upload asset', 'asset-import': 'Import asset', 'asset-audio-tracks': 'Apply audio tracks' };
