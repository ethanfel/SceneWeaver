...
function AssetCard({ hidden, asset, assets, project, mutate, preview, editable, audioTracks, organize, drag }: { organize?: () => void; drag?: boolean; hidden?: boolean; asset: ProjectAsset; assets: ProjectAsset[]; project: string; mutate: Mutate; preview: (url: string, name: string, details?: Partial<PreviewMedia>) => void; editable: boolean; audioTracks?: boolean }) {
...
export function ProjectPanel({ project, planId, branchId, workflow, connected, editable, audioTracks, libraryBridge, copyBridge, command, preview, report, scope = 'all' }: { copyBridge?: boolean; libraryBridge?: boolean; scope?: 'all' | 'audio'; project: string; planId: string; branchId: string; workflow: Workflow; connected: boolean; editable: boolean; audioTracks?: boolean; command: Command; preview: (url: string, name: string, details?: Partial<PreviewMedia>) => void; report: (error: string) => void }) {
