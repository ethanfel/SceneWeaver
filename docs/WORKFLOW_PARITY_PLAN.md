...
| ID | Required parity | 0.4 baseline | Destination / completion |
|---|---|---|---|
| A01 | Upload, browse input/output/other runs, import and preview original media; show metadata and unavailable sources | 0.5.13 other-project catalog browsing and original previews; upload/input-path import retained. Input/output source browsers and complete metadata remain partial | Media / M2 |
| A02 | Tag/role/enabled edits, duplication, ordering, folders, membership, cross-project copies and deletion with usage information | 0.5.12 folder browsing, organization, membership, ordering, duplication and deletion with selected-Plan/catalog usage; conditional writes require H3 PR #62. 0.5.13 reviewed cross-project copies via updated PR #62; complete usage analysis and production verification remain open | Media / M2 |
| A03 | Grouped-track/project duplication remaps IDs and preserves source/derived provenance | 0.5.13 copies grouped tracks with remapped IDs and source/derived provenance via updated PR #62. Whole-project duplication and production verification remain open | Media / M2 |
| A04 | Picture crop/placement, dimensions or megapixels, aspect lock, resampling and output snapping; create derived variants | 0.5.14 source editor, native sizing/geometry, reviewed derived variants and restart recovery via updated PR #62. Representative production validation remains open | Media source viewer / M2 |
| A05 | Model-based asset upscale through the Carousel's isolated job; capture a saved review frame as a tagged picture | 0.5.15 reviewed saved-clip capture in the main viewer, exact ALT/local-time provenance and restart recovery via updated PR #62. Source-viewer capture, isolated model upscale and production validation remain open | Media / M2 |
...
| E05 | Prompt history list/diff/restore/fork, original/effective/ALT prompt comparison, scene-local undo, import/export | 0.5.11 native history tree, saved/current text comparison, local restore and `.txt` import/export; conditional save/fork/label/activate/archive/delete require draft H3 PR #61. 0.5.10 prompt-local undo retained. Effective/ALT comparisons and production verification remain open | Edit history / M2, M4 |
