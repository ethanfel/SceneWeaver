...
app.post('/test/reset', (_req, res) => { pending = []; reviews = []; submissions = []; decisions = []; playback = false; adjacent = false; assets[0].tag = 'hero'; relayInstalled = false; relayFeeds.clear(); thumbnails = false; thumbnailUnavailable = false; thumbnailRevision = 'b'.repeat(32); res.json({}); });
