...
app.get('/extensions', (_req, res) => res.json(takeData ? ['h3_project_asset_manager.js', 'h3_chain_plan_studio.js', 'h3_chain_checkpoint_manager.js', 'h3_chain_top_level_requeue.js', 'h3_chain_scene_prompt_editor.js'].map(name => `/extensions/h3-test/${name}`) : []));
