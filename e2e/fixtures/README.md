...
These test fixtures contain a solid-color silent video, still and animated test patterns, and a sine-wave tone. They contain no user media or project data.
...
ffmpeg -f lavfi -i testsrc2=size=160x90:rate=1:duration=1 -frames:v 1 -q:v 4 -y clip-thumbnail.jpg
